...
const onErr=(err)=>{
  ...
  return (
    <div className="flex overflow-hidden ">
      <div className="flex overflow-hidden w-screen  bg-gray-900 text-white" >

      {/* SideBar */}
        <div className="w-1/4 bg-gray-800 p-4 ">
        
              <div 
               className="flex items-center cursor-pointer space-x-4 py-3 border-b border-gray-700">
                <WestIcon onClick={()=>navigate("/")}
                 className="text-white hover:text-sky-100 hover:bg-gray-700 hover:rounded-2xl" />
                <div onClick={()=>navigate("/")}
                className=" text-lg font-bold hover:text-sky-200 cursor-pointer">Home</div>
              </div>
