...
import { stompClient } from "../../pages/Message/Message.jsx";
import { CLEAR_CHATS } from "../Message/message.actionType.js";
...
export const registerUser = (userData) => async (dispatch) => {
  ...
  try {
    console.log("Checking User Register",userData);
...
export const logout = (navigate) =>async (dispatch) => {
  ...
  console.log("JWT after removal:", localStorage.getItem("jwt")); // ✅ Debug
